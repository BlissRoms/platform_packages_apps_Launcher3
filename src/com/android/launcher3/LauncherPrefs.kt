...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField
        val ENABLE_TWOLINE_ALLAPPS_TOGGLE = backedUpItem("pref_enable_two_line_toggle", false, EncryptionType.DEVICE_PROTECTED)
        ...
        @JvmField val DOCK_SEARCH = backedUpItem("pref_dock_search", true, EncryptionType.DEVICE_PROTECTED)
        ...
        @JvmField val DRAWER_SEARCH = backedUpItem("pref_drawer_search", true, EncryptionType.DEVICE_PROTECTED)
        ...
        @JvmField val RECENTS_MEMINFO = backedUpItem("pref_recents_meminfo", false, EncryptionType.DEVICE_PROTECTED)
        ...
        @JvmField val ROW_HEIGHT = backedUpItem("pref_row_height", 100, EncryptionType.DEVICE_PROTECTED)
        ...
        @JvmField val SHOW_DRAWER_LABELS = backedUpItem("pref_drawer_show_labels", true, EncryptionType.DEVICE_PROTECTED)
