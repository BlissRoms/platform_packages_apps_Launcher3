...
public abstract class AbstractFloatingView extends LinearLayout implements TouchController,
    ...
    @IntDef(flag = true, value = {
            ...
            TYPE_GRID_PICKER,
            TYPE_ICON_PACK_PICKER,
            TYPE_ICON_PACK_DETAIL,
    })
    ...
    public static final int TYPE_GRID_PICKER = 1 << 26;
    public static final int TYPE_ICON_PACK_PICKER = 1 << 27;
    public static final int TYPE_ICON_PACK_DETAIL = 1 << 28;
    ...
    public static final int TYPE_ALL = TYPE_FOLDER | TYPE_ACTION_POPUP
            ...
            | TYPE_NUDGE | TYPE_TASKBAR_OVERFLOW | TYPE_GRID_PICKER
            | TYPE_ICON_PACK_PICKER | TYPE_ICON_PACK_DETAIL;
