...
public final class Utilities {
    ...
    public static final String AT_A_GLANCE = "pref_at_a_glance";
    ...
    public static boolean showAtAGlance(Context context) {
	return getPrefs(context).getBoolean(AT_A_GLANCE, true);
    }
