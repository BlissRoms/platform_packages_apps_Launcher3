...
import static com.android.launcher3.LauncherPrefs.DOCK_SEARCH;
...
public class InvariantDeviceProfile {
        ...
        LauncherPrefChangeListener prefListener = key -> {
            if (FIXED_LANDSCAPE_MODE.getSharedPrefKey().equals(key)
                ...
                Trace.endSection();
                    ...
                    DOCK_SEARCH.getSharedPrefKey().equals(key)) {
                onConfigChanged();
            }
        };
    ...
    static final class DisplayOption {
        ...
        DisplayOption(GridOption grid, Context context, AttributeSet attrs) {
            ...
            try {
                iconSizeModifier = (float) LauncherPrefs.ICON_SIZE.get(context) / 100F;
                fontSizeModifier = (float) LauncherPrefs.FONT_SIZE.get(context) / 100F;
            } catch (IllegalStateException e) {
                // Storage not yet unlocked (e.g. Direct Boot), use defaults
                iconSizeModifier = 1.0F;
